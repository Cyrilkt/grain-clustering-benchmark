...
import torch
from src.clustering_models.clusternet_modules.clusternet_trainer import ClusterNetTrainer
...
class ClusterNet(object):
    ...
    def init_cluster(self, train_loader, val_loader, logger, indices=None, centers=None, init_num=0):
        ...
        self.model = ClusterNetTrainer(args=self.args, init_k=self.n_clusters, latent_dim=self.latent_dim, feature_extractor=self.feature_extractor, centers=centers, init_num=init_num)
